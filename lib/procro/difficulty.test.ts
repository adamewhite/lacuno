...
describe('planVowels', () => {
  ...
  it('gives away nothing at the easier level, but offers only vowels in play', () => {
  ...
  it('gives away one whole vowel at the medium level', () => {
  ...
  it('fills every occurrence of a given vowel, across racks', () => {
    ...
    const plan = planVowels(BLUE_MOON, 'medium');
